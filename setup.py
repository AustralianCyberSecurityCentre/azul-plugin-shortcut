...
setup(
    name="azul-plugin-shortcut",
    description="Metadata extraction from Windows shortcuts (.lnk)",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_shortcut"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-shortcut = azul_plugin_shortcut.main:main",
        ]
    },
